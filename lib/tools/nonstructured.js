...
function executeAsync( nonstructured, frequency, timeout, limit, done, progress ) {
  ...
  glob.CONTINUE.CONTINUE();
  glob.BREAK.BREAK();
  glob.AGAIN.AGAIN();
  glob.EXIT.EXIT();
  glob.LABEL.LABEL().EXIT();
